...
MODALITY_CONTRIB_GROUP_COL="broad_cell_type"  # extra .obs breakdown for modality_contribution; "None" to skip
...
python "${SCRIPT_PATH}" \
  ...
  --modality_contrib_group_col "${MODALITY_CONTRIB_GROUP_COL}" \
